...
function renderMissionsTab() {
    ...
    panels.missions.innerHTML = `
        <div class="controls">
            ...
            <p class="small">Trigger format: always | time:20 | wave:2 | pressure:0.72 | kills:25 | objective:1 | stage:extract. Actions: spawn_pack, door_action, door_thump, edge_cue, set_pressure_grace, set_reinforce_caps, trigger_tracker, morale_delta, spawn_queen, text_cue. Optional params: repeatMs, retryMs, maxFires.</p>
