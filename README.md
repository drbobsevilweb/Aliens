...
Top-down Phaser 3 tactical shooter focused on squad movement, dynamic door actions, lighting, and authored-spawn-first alien combat.
...
Code-grounded current-state planning lives at [`plan/current-state.md`](./plan/current-state.md).
...
- `http://127.0.0.1:8000/game?package=local`
